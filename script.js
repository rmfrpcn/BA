...
let quizData = {
    ...
    core: [
        ...
        { question: "スターバックスで提供しているCBRについて正しいものは?", options: ["CBRのローストレベルはDARK", "CBRはラテンアメリカ産とアジア/太平洋産のブレンド", "マルコニックグラインダー#10番で挽いた豆を使う", "常温で14時間かけて抽出を行う"], correct: 3, explanation: "『1.CBRのローストレベルはDARK』CBRはMEDIUMロースト、『2.CBRはラテンアメリカ産とアジア/太平洋産のブレンド』CBRはラテンアメリカ産とアフリカ産のブレンド、『3.マルコニックグラインダー#!0番で挽いた豆を使う』正しくは#8番" },
